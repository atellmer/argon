...
import { StatefullComponentFactoryType, StatelessComponentFactoryType } from '../component';
...
type RepeatDirectiveType = {
  ...
  createElement: (
    item: any,
    idx: number,
  ) => VirtualNodeType | Array<VirtualNodeType> | StatelessComponentFactoryType | StatefullComponentFactoryType;
};
